          ...
          <div className="fixed inset-0 z-[50] flex items-center justify-center p-4">
            ...
            >
              ...
              <form onSubmit={handleBooking} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Tipo de Atendimento</label>
                  <select 
                  ...
                  >
                    <option value="Consulta Presencial" className="bg-slate-900">Consulta Presencial (Domicílio)</option>
                    <option value="Teleconsulta" className="bg-slate-900">Teleconsulta (Online)</option>
                  </select>
                </div>
                ...
                <div className="p-4 bg-blue-600/10 rounded-2xl border border-blue-500/20 flex items-center justify-between">
                  ...
                  <span className="text-lg font-black text-blue-400">R$ {physio.preco_sessao || '---'}</span>
                </div>
